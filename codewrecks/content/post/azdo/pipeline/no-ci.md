...
There was a bug in the past where \*\*\*NO_CI\*\*\* was not honored in AzureDevOps pipeline, but now, accordingly to [this issue](https://github.com/Microsoft/azure-pipelines-agent/issues/858) everything was solved, and we have also other token that we can use, like **[skip ci]** and others.
