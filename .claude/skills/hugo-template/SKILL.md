...
{{</* Named parameters */>}}
{{< figure src="https://raw.githubusercontent.com/hughescr/claude-code-config/4e1acdf430252fc99e3226cefc5fa9aa213a25f9/plugins/hugo/skills/hugo-templating//images/photo.jpg" title="My Photo" alt="Description" >}}
...
<figure{{ with $class }} class="{{ . }}"{{ end }}>
  <img src="https://raw.githubusercontent.com/hughescr/claude-code-config/4e1acdf430252fc99e3226cefc5fa9aa213a25f9/plugins/hugo/skills/hugo-templating/{{ $src }}" alt="{{ $alt }}">
...
<link rel="stylesheet" href="https://github.com/hughescr/claude-code-config/blob/4e1acdf430252fc99e3226cefc5fa9aa213a25f9/plugins/hugo/skills/hugo-templating/{{ $style.RelPermalink }}">
